            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
                    <View style={styles.card}>
                        ...
                        <ProfileField label="Street Address" icon="map-pin" value={form.address} onChangeText={v => updateField('address', v)} editable={isEditing} />
                        <View style={styles.row}>
                            <View style={{ flex: 1 }}>
                                <ProfileField label="City" icon="building" value={form.city} onChangeText={v => updateField('city', v)} editable={isEditing} />
                            </View>
                            <View style={{ flex: 1 }}>
                                <ProfileField label="Province" icon="map" value={form.province} onChangeText={v => updateField('province', v)} editable={isEditing} />
                            </View>
                        </View>
