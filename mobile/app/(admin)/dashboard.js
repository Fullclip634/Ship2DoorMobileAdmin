...
const styles = StyleSheet.create({
    ...
    headerSub: { fontSize: Fonts.sizes.sm, fontFamily: Fonts.medium, color: Colors.textSecondary, marginTop: 2 },
    addBtn: {
    ...
    orderNum: { fontSize: Fonts.sizes.sm, fontFamily: Fonts.bold, color: Colors.secondary },
    orderCustomer: { fontSize: Fonts.sizes.xs, color: Colors.textSecondary, fontFamily: Fonts.medium, marginTop: 2 },
    orderItem: { fontSize: Fonts.sizes.sm, color: Colors.text, fontFamily: Fonts.semiBold },
});
